...
/**
@file indicator_plugin.h
@brief Implementacja pluginu komponentu Indicator - plik nagłówkowy
...
class IndicatorPlugin : public QObject, public QDesignerCustomWidgetInterface
{
		Q_OBJECT
